...
import Compiler.Tests.DotP.Templates
...
main2 :: IdxMonad IO ()
main2 = do
  lift $ putStrE "DotP code gen from solution source:\n"  
  let relDir = "/Compiler/Tests/DotP/"
  ...
  -- load source file
  let testFile = curDir ++ relDir ++ "lineFit.flocc" --"stddev.flocc" --"dotProd.flocc"
